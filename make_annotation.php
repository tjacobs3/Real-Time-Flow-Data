<?php
  function add_annotation($l, $ct, $sn, $t, $a) {
    ...
    $query = "INSERT INTO Annotation (location, chart_type, series_name, time, annotation) VALUES ('" . $l . "','" . $ct . "','" . $sn . "','" . $t . "','" . $a . "');";
  ...
  add_annotation($location, $chart_type, $series_name, $time, $annotation);
?>
